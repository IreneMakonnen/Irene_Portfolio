...
![Retrieve after hours failed login attempts](<attachments/3. Linux and SQL/Applying filters to SQL queries.png>)
...
<video controls src="attachments/3. Linux and SQL/Retrieve.login.attempts.on.specific.dates.mp4" title="Retrieve login attempts on specific dates"></video>
---
...
<video controls src="attachments/3. Linux and SQL/Retrieve.login.attempts.outside.of.Mexico.mp4" title="Retrieve login attempts outside of Mexico"></video>
...
<video controls src="attachments/3. Linux and SQL/Retrieve.employees.in.Marketing.mp4" title="Retrieve employees in Marketing"></video>
---
...
<video controls src="attachments/3. Linux and SQL/Retrieve.employees.in.Finance.or.Sales.mp4" title="Retrieve employees in Finance or Sales"></video>
...
<video controls src="attachments/3. Linux and SQL/Retrieve.all.employees.not.in.IT.mp4" title="Retrieve all employees not in IT"></video>
