...
![Check file and directory details 1](<attachments/3. Linux and SQL/File permissions in Linux 1.png>)
...
![Check file and directory details 2](<attachments/3. Linux and SQL/File permissions in Linux 2.png>)
...
![Describe the permissions string](<attachments/3. Linux and SQL/File permissions in Linux 3.png>)
...
![Change file permissions 1](<attachments/3. Linux and SQL/File permissions in Linux 4.png>)
...
![Change file permissions 2](<attachments/3. Linux and SQL/File permissions in Linux 5.png>)
...
![Change file permissions on a hidden file 1](<attachments/3. Linux and SQL/File permissions in Linux 6.png>)
...
![Change file permissions on a hidden file 2](<attachments/3. Linux and SQL/File permissions in Linux 7.png>)
...
![Change directory permissions](<attachments/3. Linux and SQL/File permissions in Linux 8.png>)
