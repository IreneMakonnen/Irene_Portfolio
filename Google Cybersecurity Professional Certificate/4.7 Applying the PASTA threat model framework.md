...
![PASTA data flow diagram](<attachments/4. Assets, Threats, and Vulnerabilities/Applying the PASTA threat model framework 1.png>)
...
![PASTA attack tree](<attachments/4. Assets, Threats, and Vulnerabilities/Applying the PASTA threat model framework 2.png>)
