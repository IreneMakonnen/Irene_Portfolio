...
![Performing a domain search](<attachments/5. Detection and Response/Performing a query with Chronicle 1.png>)
...
Clicking on this IP will run a new search for the IP address in Chronicle. 
    ...
    ![RESOLVED IPS](<attachments/5. Detection and Response/Performing a query with Chronicle 2.png>)
...
- **TIMELINE**: This tab provides information about the events and interactions made with this domain. 
    ...
    ![TIMELINE](<attachments/5. Detection and Response/Performing a query with Chronicle 3.png>)
    ...
    ![TIMELINE: EXPAND ALL](<attachments/5. Detection and Response/Performing a query with Chronicle 4.png>)

- **ASSETS**: This tab provides a list of the assets that have accessed the domain.

    ![ASSETS](<attachments/5. Detection and Response/Performing a query with Chronicle 5.png>)
...
![Investigating the threat intelligence data](<attachments/5. Detection and Response/Performing a query with Chronicle 6.png>)
...
![Investigating the affected assets and events: ASSETS](<attachments/5. Detection and Response/Performing a query with Chronicle 5.png>)
...
![Investigating the affected assets and events: TIMELINE](<attachments/5. Detection and Response/Performing a query with Chronicle 8.png>)
...
- **TIMELINE**: The additional POST requests are 3. A new `POST` suggests that an asset may have been phished.
    ...
    ![Investigating resolved IP addresses: TIMELINE](<attachments/5. Detection and Response/Performing a query with Chronicle 9.png>)

- **ASSETS**: The additional affected assets are 3

    ![Investigating resolved IP addresses: ASSETS](<attachments/5. Detection and Response/Performing a query with Chronicle 10.png>)

- **DOMAINS**: There are 2 domains associated with this IP Address.

    ![Investigating resolved IP addresses: DOMAINS](<attachments/5. Detection and Response/Performing a query with Chronicle 11.png>)
